...
function infinity_offscreen_content_output() {
	...
	if ( is_active_sidebar( 'offscreen-content' ) ) {
		...
		echo '<div class="offscreen-content-icon"><button class="offscreen-content-toggle"><i class="ion-ios-calendar-outline"></i> <span class="screen-reader-text">' . __( 'Show Offscreen Content', 'infinity-pro' ) . '</span></button></div>';
...
function sp_footer_creds_filter( $creds ) {
	$creds = '[footer_copyright] &middot; <a href="http://daviscps.com">Davis Cosmetic Plastic Surgery</a> • <a href="https://daviscps.com/privacy-policy/">Privacy Policy</a> • <a href="http://trinitywebmedia.com">New Jersey Web Design</a> by <a href="http://trinitywebmedia.com">Trinity Web Media</a>';
	return $creds;
}
genesis_register_sidebar( array(
'id' => 'page-image',
'name' => __( 'Page Image', 'genesis' ),
'description' => __( 'Page Image', 'infinity-pro' ),
) );
